<template>
  <div id="__template">
    <Header />
    <section class="template-section-3 py-4 overflow-hidden">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-2">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb bg-white shadow-sm font-size-14">
                <li class="breadcrumb-item"><a class="text-dark" href="#">首页</a></li>
                <li class="breadcrumb-item"><a class="text-dark" href="#">秋招简历</a></li>
                <li class="breadcrumb-item active" aria-current="page">Java程序员简历模板</li>
              </ol>
            </nav>
          </div>
          <div class="col-md-2">
            <div class="nav flex-column nav-pills">
              <a class="nav-link active bg-dark" href="#v-pills-home"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="mb-1 mr-2 bi bi-file-earmark-word-fill" viewBox="0 0 16 16">
          ...
          <div class="col-md-4">
            <div class="bg-white shadow-sm overflow-hidden rounded-lg p-4">
              <h4 class="text-dark">Java程序员简历模板</h4>
              <p class="text-muted mt-2 font-size-14">发布于2020-12-19 / 已有12321人使用</p>
              <p class="bg-light rounded-lg font-size-14 py-2 px-3 border mt-3 mb-4 text-muted">适合2021届秋招投递参考，专为应届生秋招设计的简历模板，有实习、项目、校园经历，帮你在秋招中脱颖而出 | 2021秋招简历模板</p>
              <a class="btn btn-danger px-4 mr-1" href=""><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="mr-2 bi bi-hand-index-thumb-fill" viewBox="0 0 16 16">
              ...
              <a class="btn btn-outline-dark px-4" href=""><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="mr-2 bi bi-heart-fill" viewBox="0 0 16 16">
                <path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z"/>
              </svg>收藏</a>
            </div>
            <div class="mt-4 bg-white shadow-sm overflow-hidden rounded-lg p-4">
              <h6><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="mb-1 mr-2 bi bi-hand-thumbs-up-fill" viewBox="0 0 16 16">
              ...
              <ul class="row recommend-editer">
                <li class="col-12 col-md-6 overflow-hidden mt-3 pb-2">
...
export default {
  data() {
    return {
      paramsId: this.$route.params.id.split('.html')[0]
    }
  },
  head() {
    return {
      title: '内容页 - 简历模板 - 极速简历 WorkerCV'
    }
  },
  mounted() {
